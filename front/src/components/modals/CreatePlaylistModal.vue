...
const submitHandler = async (data: CreatePlaylistFormData) => {
  ...
  try {
    ...
    const newPlaylist = await apiClient.playlist.createPlatform({
      title: data.title.trim(),
    });

    const playlistData = {
      musics: formData.value.musics.map((musicId) => ({ music: musicId })),
    };

    await apiClient.playlist.update(newPlaylist.id as string, playlistData);
        ...
        >
          <div class="flex flex-col justify-between h-full">
            ...
            <div class="flex-1 overflow-y-auto scrollbar-custom">
              <div class="p-6 space-y-6 overflow-y-auto scrollbar-custom h-full">
                <!-- Titre -->
                <FormKit
                  type="text"
                  name="title"
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <div
                      v-if="searchResults.length > 0 || loadingMusics"
            ...
            <!-- Footer -->
            <div class="p-6 border-t border-[#440a50] bg-[#2a0d35]/50 flex-shrink-0">
